...
public class BhReportApply implements Serializable {
     ...
     * 是否是助贷业务
     */
    @TableField("IS_FINTECH_AGENCY_BUSINESS")
     ...
     * 业务发生机构代码
     */
    @TableField("BUSINESS_ORG_CREDIT_CODE")
    private String businessOrgCreditCode;
     ...
     * 文件流水号
     */
    @TableField("FILE_FLOW_NO")
    private Integer fileFlowNo;
